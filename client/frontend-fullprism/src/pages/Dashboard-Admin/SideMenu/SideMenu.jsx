...
const SideMenu= ()=> {
   ...
   function handleClick(e, name) {
    ...
    return (
        <div className="">
            <div>
               <button className=" text-white flex flex-row items-center gap-2 justify-center text-xs bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg px-5 py-2 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" type="button" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation" >
                  <FiMenu /> <span>MENU TABLEROS</span>
               </button>
            </div>

            <div id="drawer-navigation" className=" pt-40 fixed top-0 place-items-baseline h-screen left-0 z-40 w-64 p-4 overflow-y-auto transition-transform -translate-x-full bg-gray-700" tabindex="-1" aria-labelledby="drawer-navigation-label">
               <h5 id="drawer-navigation-label" className="text-base font-semibold text-gray-300 uppercase dark:text-gray-400">Menu Tableros</h5>
               <button type="button" data-drawer-hide="drawer-navigation" aria-controls="drawer-navigation" className="mt-36 text-gray-300 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" >
